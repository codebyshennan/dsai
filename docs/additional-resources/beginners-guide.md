...
- **Module READMEs** list tools, time estimates, and lesson order.
- **Visualization module** extras: [quick start](../3-data-visualization/quick-start.md), [FAQ](../3-data-visualization/FAQ.md), [glossary](../3-data-visualization/glossary.md).
- **Glossary and FAQ** (course-wide): [glossary](glossary.md), [faq](faq.md).
